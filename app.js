...
function renderTree() {
    ...
    sortedPeople.forEach(person => {
        ...
        nameText.setAttribute("font-size", gen <= 2 ? "18" : "16"); // Größere Schrift für Gen 1 & 2
        ...
        const maxLength = Math.floor((boxWidth - 40) / (gen <= 2 ? 7 : 8)); // Mehr Platz für größere Schrift
        ...
        detailsText.setAttribute("font-size", gen <= 2 ? "16" : "15"); // Größere Schrift für Gen 1 & 2
